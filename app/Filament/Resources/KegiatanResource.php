        ...
        return $form
            ->schema([
                Forms\Components\Group::make()
                    ->schema([
                        Forms\Components\Section::make('Settings Activity')
                            ->schema([
                                Forms\Components\Select::make('periode_id')
                                    ...
                                    ->afterStateUpdated(function (Set $set) {
                                        $set('program_id', null);
                                        $set('program.kode', null);
                                        $set('program.sisa_pagu', null);
                                    })
                                    ->required(),
                ...
                Forms\Components\Group::make()
                    ->schema([
                        Forms\Components\Section::make('Assign to User')
                            ->schema([
                        ...
                        Forms\Components\Section::make('Information Pagu')
                            ->schema([
